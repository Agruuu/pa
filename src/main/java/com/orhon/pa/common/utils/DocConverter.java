...
public class DocConverter {
	  private static final int environment = 1;// 环境1：windows,2:linux(涉及pdf2swf路径问题)  
	            ...
	            if (pdfFile.exists()) {  
	                ...
	                {  
	                    try {  
	                        ...
	                        Process p = r.exec("C:\\home\\orhon\\opa\\upload\\ast\\ " + pdfFile.getPath() + " -o " + swfFile.getPath() + " -T 9");  
	    ...
	    public static void main(String s[]) {  
	    	//修改1-不支持中文路径和中文文档
	        DocConverter d = new DocConverter("C:\\Users\\Administrator\\Desktop\\dddddd.docx");  
	        d.conver();  
	    }  
	}  