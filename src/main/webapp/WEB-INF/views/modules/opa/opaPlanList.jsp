...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/opa/opaPlan/index">考核计划列表</a></li>
		<shiro:hasPermission name="opa:opaPlan:edit"><li><a href="${ctx}/opa/opaPlan/form">考核计划添加</a></li></shiro:hasPermission>
	</ul>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead>
			<tr>
				...
				<th>截止日期</th>
				<th>状态</th>
				<shiro:hasPermission name="opa:opaPlan:edit"><th>操作</th></shiro:hasPermission>
			</tr>
		</thead>
		<tbody>
			...
			<tr>
				...
				<td>
					...
					<c:if test="${opaPlan.status eq fns:getDictValue('待执行','opa_plan_status','')}">
						<shiro:hasPermission name="opa:opaPlan:excute">
