...
<body>
		...
		<div id="office" class="accordion-group span3 height-full">
		  ...
		  <div id="user" class="accordion-group span2 height-full">
			<div class="accordion-heading">
				...
				<input name="aCheck" style="float:right;margin-top:-25px;margin-right:5px;vertical-align:middle;" 
				value="checked" type="checkbox" id="checkbox_All" onclick = "checkAllDept();">
			</div>
	...
	<script type="text/javascript">
		...
		*/
		...
		//被考核部门  全选/反选批量选择
		var checkAllDept = function(){
			var chkValue = $("#checkbox_All").val();
			var userTreeObj = $.fn.zTree.getZTreeObj("userTree");//拿到的所有部门的数据
			if (chkValue == "unChecked"){
				userTreeObj.checkAllNodes(false);
				$("#checkbox_All").val("checked");
			}else{
			   userTreeObj.checkAllNodes(true);
			   $("#checkbox_All").val("unChecked");
			}
