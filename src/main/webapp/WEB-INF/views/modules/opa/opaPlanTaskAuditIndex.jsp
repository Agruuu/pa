			...
			var str="";
			  if((row.status == "${fns:getDictValue('待审核', 'opa_planTask_status', '')}")){ 
				  /*if((row.status == "${fns:getDictValue('待执行', 'opa_planTask_status', '')}")){*/
					//上报
					str+="<shiro:hasPermission name='opa:opaPlanTask:audit:pass'><a href='${ctx}/opa/opaPlanTask/audit/pass?id="+row.id 
...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/opa/opaPlanTask/audit/index">计划任务列表</a></li>
	</ul>
