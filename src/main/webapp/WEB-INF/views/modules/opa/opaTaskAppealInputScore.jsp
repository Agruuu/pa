...
<body>
	...
	<form:form id="inputForm" modelAttribute="opaTaskAppeal" action="${ctx}/opa/opaTaskAppeal/saveInputScore" method="post" class="form-horizontal">
		...
		<div id="content" class="form-search">
				...
				<label id="inputResult">完成数目：<form:input path="result" htmlEscape="false" class="input-mini required number" onblur="calScore(this.value);"/>&nbsp;&frasl;&nbsp;${opaTaskAppeal.count}</label>
		</div>
		...
		<div class="form-actions">
			<shiro:hasPermission name="opa:opaTaskAppeal:excute:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
		</div>
	</form:form>
</body>
</html>