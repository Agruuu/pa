...
<head>
	...
	<script type="text/javascript">
		...
		function save(){
			$("#inputForm").attr("action", "${ctx}/opa/opaTaskAppeal/save");
			$("#inputForm").submit();
		}
...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/opa/opaTaskAppeal/form?id=${opaTaskAppeal.id}">绩效反馈<shiro:hasPermission name="opa:opaTaskAppeal:edit">${not empty opaTaskAppeal.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="opa:opaTaskAppeal:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="opaTaskAppeal" action="${ctx}/opa/opaTaskAppeal/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:select path="planId" class="input-xlarge required">
					...
					<form:options items="${fns:getDictList('opa_plan_status')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
				</form:select>
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<form:select path="TaskId" class="input-xlarge required">
					<form:option value="" label=""/>
					<form:options items="${fns:getDictList('opa_planTask_status')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
				</form:select>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
			<input type='file' name='attachedpath'  />
		...
		<%--  <div class="control-group">
		 ...
		 <%--   <div class="control-group">
			<label class="control-label">审核者：</label>
			<div class="controls">
				<sys:treeselect id="auditor" name="auditor.id" value="${opaTaskAppeal.auditor.id}" labelName="" labelValue="${opaTaskAppeal.auditor.name}"
	...
	<%-- 	<div class="control-group">
		...
		<%--   <div class="control-group">
			...
			<div class="controls">
				<form:select path="status" class="input-xlarge required">
					<form:option value="" label=""/>
					<form:options items="${fns:getDictList('opa_taskAppeal_status')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
				</form:select>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>   --%>
		...
		<div class="form-actions">
			<shiro:hasPermission name="opa:opaTaskAppeal:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"  onclick="save()"/>&nbsp;</shiro:hasPermission>
