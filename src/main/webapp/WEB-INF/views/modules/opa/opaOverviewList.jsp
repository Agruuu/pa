...
<body>
	<ul class="nav nav-tabs">
		...
		<shiro:hasPermission name="opa:opaOverview:edit"><li><a href="${ctx}/opa/opaOverview/form">添加评分</a></li></shiro:hasPermission>
	</ul>
	<form:form id="searchForm" modelAttribute="opaOverview" action="${ctx}/opa/opaOverview/" method="post" class="breadcrumb form-search">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="opaOverview">
			<tr>
				...
				<shiro:hasPermission name="opa:opaOverview:edit"><td>
    				<a href="${ctx}/opa/opaOverview/form?id=${opaOverview.id}">修改</a>
					<a href="${ctx}/opa/opaOverview/delete?id=${opaOverview.id}" onclick="return confirmx('确认要删除该综合评分吗？', this.href)">删除</a>
