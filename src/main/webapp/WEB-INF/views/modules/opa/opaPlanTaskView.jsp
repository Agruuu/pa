...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/opa/opaPlanTask/index">指标列表</a></li>
		<li class="active"><a href="${ctx}/opa/opaPlanTask/view?parentId=${parentId}">指标明细表</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="opaPlanTask" action="${ctx}/opa/opaPlanTask/save?parentId=${parentId}" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:textarea path="examination" htmlEscape="false" rows="6" maxlength="2000" class="input-xxlarge "/>
			</div>
		</div>
		<div class="control-group">
...
<%-- 		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<input name="dateFrom" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate required"
					value="<fmt:formatDate value="${opaPlanTask.dateFrom}" pattern="yyyy-MM-dd"/>"
		...
		<div class="control-group">
			...
			<div class="controls">
				<input name="dateTo" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate required"
					value="<fmt:formatDate value="${opaPlanTask.dateTo}" pattern="yyyy-MM-dd"/>"
					onclick="WdatePicker({dateFmt:'yyyy-MM-dd',isShowClear:true});"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		...
		<div class="form-actions">
			<!-- <shiro:hasPermission name="opa:opaPlanTask:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission> -->
