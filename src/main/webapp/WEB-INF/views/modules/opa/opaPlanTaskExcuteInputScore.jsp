...
<body>
	...
	<form id="viewForm" action="${ctx}/opa/opaPlanTask/preview/see" method="get" enctype="multipart/form-data" class="form-horizontal">
		<sys:message content="${message}"/>
		<div id="uploadContent" class="form-search">
		<input type="hidden" name="id" value="${opaPlanTask.id}"/>
	...
	<form:form id="inputForm" modelAttribute="opaPlanTask" action="${ctx}/opa/opaPlanTask/saveInputScore" method="post" class="form-horizontal">
		...
		<div class="form-actions">
			<shiro:hasPermission name="opa:opaPlanTask:excute:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="完成上传"/>&nbsp;</shiro:hasPermission>
		</div>
	</form:form>
