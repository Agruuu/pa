	...
	<script type="text/javascript">
		...
		function btnRender(row){
			...
			if((row.status == "${fns:getDictValue('填报待审核', 'opa_schemeItem_status', '')}")){
					//上报
					str+="<shiro:hasPermission name='opa:opaSchemeItem:apply:audit:pass'><a href='${ctx}/opa/opaSchemeItem/apply/audit/pass?id="+row.id 
					+"&schemeId="+row.schemeId+"' onclick='return applyAuditPass(this.href)'>审核通过</a>&nbsp;</shiro:hasPermission>";
					str+="<shiro:hasPermission name='opa:opaSchemeItem:apply:audit:return'><a href='${ctx}/opa/opaSchemeItem/apply/audit/return?id="+row.id 
...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/opa/opaSchemeItem/apply/audit/index">方案指标列表</a></li>
	</ul>
