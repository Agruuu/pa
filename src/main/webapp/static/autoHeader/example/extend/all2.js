...
function showView(){
    ...
    var treejson = headjson_ ;
    var headjson1_=header1_;
    currentJson = bodyjson = bodyjson_ ;
    initTable("tabled",headjson_,bodyjson_,headjson1_);
    $.fn.zTree.init($("#header_tree"), setting, treejson);
    console.log(headjson_)
...
var treejson_ =
	[{id:1,  name: "三年级","isParent":1,"open":false},
